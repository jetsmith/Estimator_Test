...
from train_face2.nets import LMobilenetE, resnet_arcface, resnet_utils_arcface
slim = tf.contrib.slim

networks_map = {'LMobilenetE': LMobilenetE.mobilenet_v1,
        'resnet_arcface': resnet_arcface.resnet_v1_50}

arg_scopes_map = {'LMobilenetE': LMobilenetE.mobilenet_v1_arg_scope,
