...
class SSDNet(object):
    ...
    default_params = SSDParams(
        ...
        feat_layers=['block3', 'block4', 'block7', 'block8', 'block9', 'block10'],
...
def ssd_multibox_layer(inputs,
    ...
    # Class prediction.
    net = slim.conv2d(net, 96, [3, 3], activation_fn=None,
                      scope='conv_cls_1')
...
def ssd_losses(logits, localisations,
               ...
               alpha=1.,
               label_smoothing=0.,
               cls_loss_fn=tf.nn.sparse_softmax_cross_entropy_with_logits,
               is_training=True,
               device='/cpu:0',
               scope=None):
    with tf.name_scope(scope, 'ssd_losses'):
        ...
        with tf.name_scope('cross_entropy_pos'):
            ploss = tf.nn.sparse_softmax_cross_entropy_with_logits(
        ...
        with tf.name_scope('cross_entropy_neg'):
            nloss = tf.nn.sparse_softmax_cross_entropy_with_logits(
