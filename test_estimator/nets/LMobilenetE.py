    ...
    with slim.arg_scope([slim.batch_norm, slim.dropout],
      ...
      with tf.variable_scope('Logits'):
        if global_pool:
          ...
          # LMobilenetE E option
          net = slim.flatten(net, scope='flatten')
          net = slim.batch_norm(net, epsilon=2e-5, is_training=is_training)
          net = slim.dropout(net, dropout_keep_prob=0.4,
                  is_training=is_training, scope='dropout_embed')
          net = slim.fully_connected(net, 512, normalizer_fn=None, scope='embeddings')
          net = slim.batch_norm(net, scale=True, epsilon=2e-5, is_training=is_training)
          end_points['embeddings'] = net
        ...
        logits = slim.fully_connected(net, num_classes, bias_init=None,
                activation_fn=None, normalizer_fn=None, scope='fc')
